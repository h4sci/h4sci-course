...
- **tests** automated tests ([basic idea in the RSE Book Carpentry](https://rse-book.github.io/programming.html#testing)), often created with a testing framework such as [testthat](https://cran.r-project.org/web/packages/testthat/index.html) or [tinytest](https://cran.r-project.org/web/packages/tinytest/index.html)
