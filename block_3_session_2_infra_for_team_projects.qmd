...
- understand the difference between static and dynamic web projects
- find the stack for team projects



# Introduction to GitHub Pages (and other static hosts)


## Examples {.center}

- **personal repository page**: [mbannert.github.io/timeseriesdb](https://mbannert.github.io/timeseriesdb)
- **organization page**: [https://rse-book.github.io/](https://rse-book.github.io/)
...
## How to Create Content for Static Hosts? {.center}

<!-- show, quarto. show astro cli --> 
